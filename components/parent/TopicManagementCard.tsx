...
export default function TopicManagementCard({
  childAccountId: _childAccountId,
  childName,
}: TopicManagementCardProps) {
  return (
      ...
      <div className="space-y-4">
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          ...
          <p className="text-sm text-blue-700">
            Real-time content monitoring with intelligent categorization and
            parent alerts.
          </p>
        </div>
        ...
        <div className="bg-green-50 border border-green-200 rounded-lg p-4">
          ...
          <p className="text-sm text-green-700">
            Create custom rules for topics your child discusses with AI-powered
            suggestions.
          </p>
        </div>
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
          ...
          <p className="text-sm text-yellow-700">
            Instant notifications for concerning content with educational
            recommendations.
          </p>
        </div>
        ...
        <div className="mt-4 p-3 bg-gray-50 rounded-lg border">
          <p className="text-xs text-gray-600 text-center">
            Full content control interface coming soon with topic rules,
            suggestions, and alert management.
          </p>
        </div>
      </div>
    </div>
