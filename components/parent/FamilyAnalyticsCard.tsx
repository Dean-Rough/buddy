  ...
  const loadFamilyAnalytics = async () => {
    try {
      ...
      const response = await fetch(
        `/api/parent/family-analytics?timeframe=${timeframe}&respectPrivacy=true`
      );
      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          <div className="text-center">
            <div className="text-2xl font-bold">
              {analytics.familyMetrics.totalChildren}
            </div>
            <div className="text-sm text-gray-600">Total Children</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold">
              {analytics.familyMetrics.activeChildren}
            </div>
        ...
        <div className="space-y-3 mb-6">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-2">
              <span
                className={`font-bold ${getScoreColor(analytics.familyMetrics.familyEngagementScore)}`}
              >
                {getScoreLabel(analytics.familyMetrics.familyEngagementScore)}
              </span>
              <span className="text-sm text-gray-600">
                {Math.round(
                  analytics.familyMetrics.familyEngagementScore * 100
                )}
                %
              </span>
            </div>
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-2">
              <span
                className={`font-bold ${getScoreColor(analytics.familyMetrics.familySafetyScore)}`}
              >
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-2">
              <span
                className={`font-bold ${getScoreColor(analytics.familyMetrics.familyLearningScore)}`}
              >
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-2">
              <span
                className={`font-bold ${getScoreColor(analytics.familyMetrics.familyScreenTimeBalance)}`}
              >
                {getScoreLabel(analytics.familyMetrics.familyScreenTimeBalance)}
              </span>
              <span className="text-sm text-gray-600">
                {Math.round(
                  analytics.familyMetrics.familyScreenTimeBalance * 100
                )}
                %
              </span>
            </div>
          ...
          {analytics.familyMetrics.totalChildren > 1 && (
            <div className="flex justify-between items-center">
              ...
              <div className="flex items-center gap-2">
                <span
                  className={`font-bold ${getScoreColor(analytics.familyMetrics.siblingInteractionHealth)}`}
                >
                  {getScoreLabel(
                    analytics.familyMetrics.siblingInteractionHealth
                  )}
                </span>
                <span className="text-sm text-gray-600">
                  {Math.round(
                    analytics.familyMetrics.siblingInteractionHealth * 100
                  )}
                  %
                </span>
              </div>
        ...
        {analytics.familyInsights.topSharedInterests.length > 0 && (
          <div className="mb-4">
            ...
            <div className="flex flex-wrap gap-2">
              {analytics.familyInsights.topSharedInterests
                .slice(0, 5)
                .map((interest, index) => (
                  <span
                    key={index}
        ...
        {analytics.familyInsights.familyStrengths.length > 0 && (
          <div className="mb-4">
            ...
            <div className="space-y-1">
              {analytics.familyInsights.familyStrengths
                .slice(0, 3)
                .map((strength, index) => (
        ...
        {analytics.familyInsights.areasForImprovement.length > 0 && (
          <div className="mb-4">
            ...
            <div className="space-y-1">
              {analytics.familyInsights.areasForImprovement
                .slice(0, 3)
                .map((area, index) => (
                  <div key={index} className="flex items-center gap-2">
        ...
        {analytics.familyInsights.parentActionItems.length > 0 && (
          <div className="mb-4">
            ...
            <div className="space-y-1">
              {analytics.familyInsights.parentActionItems
                .slice(0, 3)
                .map((action, index) => (
                  <div key={index} className="flex items-center gap-2">
        ...
        <div className="border-t pt-4">
          ...
          {analytics.privacyCompliance.childrenWithRestrictedData.length >
            0 && (
            <div className="text-xs text-gray-500 mt-1">
              {analytics.privacyCompliance.childrenWithRestrictedData.length}{' '}
              child(ren) with privacy restrictions
            </div>
          )}
        </div>
